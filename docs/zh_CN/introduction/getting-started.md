...
您可以在这里下载 Clash 的内核二进制文件: [https://github.com/Jlz0/clash/releases](https://github.com/Jlz0/clash/releases)
...
对于其他构建目标, 请查看 [Makefile](https://github.com/Jlz0/clash/blob/master/Makefile).